...
Plans:
- [x] 14-01-PLAN.md -- cfk_operator role: Helm deployment, CR readiness gates, deploy-cfk.yml playbook
- [x] 14-02-PLAN.md -- cfk_topic role: CPTopic-to-KafkaTopic CRD generation with governance parity
